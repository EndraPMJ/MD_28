...
public class MainActivity extends AppCompatActivity
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_settings) {
            ...
            Intent telfon = new Intent(Intent.ACTION_DIAL, Uri.parse("tel:081215730724"));
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_home) {
            ...
            getSupportFragmentManager().beginTransaction().replace(R.id.FragmentLayout, new GalleryFragment())
                    .commit();
            ...
            share.putExtra(Intent.EXTRA_TEXT, "HALO GAESS");
            startActivity(Intent.createChooser(share, "Share to your friend"));

        } else if (id == R.id.nav_send) {
            Intent sms = new Intent(Intent.ACTION_SENDTO,Uri.parse("smsto:081215730724"));
            sms.putExtra("sms_body","Ini Endra Ya???");
            startActivity(sms);
